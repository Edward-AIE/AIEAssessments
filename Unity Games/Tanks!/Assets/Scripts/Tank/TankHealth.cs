...
public class TankHealth : MonoBehaviour
{
    ...
    private void Awake()
    {
        //Instantiate the explosion prefab adn get a reference to the particle system on it
        m_ExplosionParticles = Instantiate(m_ExplosionPrefab).GetComponent<ParticleSystem>();

        //Disable the prefab so it cna be activated when it's required
    ...
    public void TakeDamage(float amount)
    {
        ...
        //Change UI elements appropriately
        SetHealthUI();
